...
class Commands(discord.Cog, name="Commands"):
    ...
    @discord.slash_command(
        name="ask",
        description="Kamu tanya, saya jawab!",
        guild_ids=ALLOWED_GUILDS,
    )
    @discord.option(
    ...
    @discord.slash_command(
        name="edit",
        description="Mau minta edit sesuatu juga boleh!",
        guild_ids=ALLOWED_GUILDS,
    )
    @discord.option(
        name="instruction",
        description="Intruksi untuk edit, bisa kosong",
        required=True,
    )
    @discord.option(
        name="text",
        description="Text yang ingin di edit, bisa kosong",
        required=False,
        default="",
    )
    @discord.option(
    ...
    @discord.slash_command(
        name="converse",
        description="Curhat sini, saya tau anda galau",
        guild_ids=ALLOWED_GUILDS,
    )
    @discord.option(
        name="opener",
    ...
    @discord.slash_command(
        name="draw",
        description="Kamu tidak bisa menggambar? Cukup berimajinasi!",
        guild_ids=ALLOWED_GUILDS,
    )
    ...
    @discord.slash_command(
        name="optimize",
        description="Optimize your text prompt for image generation.",
        guild_ids=ALLOWED_GUILDS,
    )
    @discord.option(
    ...
    @discord.slash_command(
        name="setup",
        description="Setup your API key for use",
        guild_ids=ALLOWED_GUILDS,
    )
    @discord.guild_only()
